...
describe 'Quadlets::Unit::Network' do
  ...
  it { is_expected.to allow_value({ 'Gateway'              => ['192.0.2.2', '192.0.2.3'] }) }
  ...
  it { is_expected.to allow_value({ 'InterfaceName'        => 'br0' }) }
  ...
  it { is_expected.to allow_value({ 'IPRange'              => ['192.0.2.10-192.0.2.50'] }) }
  ...
  it { is_expected.to allow_value({ 'ServiceName'          => 'my-network' }) }
  it { is_expected.to allow_value({ 'Subnet'               => '192.0.2.0/24' }) }
  it { is_expected.to allow_value({ 'Subnet'               => ['192.0.2.0/24', '192.0.4.0/24'] }) }
end
