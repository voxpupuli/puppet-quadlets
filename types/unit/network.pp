...
type Quadlets::Unit::Network = Struct[
  ...
  Optional['Gateway']              => Variant[String[1], Array[String[1],1]],
  Optional['GlobalArgs']           => Variant[String[1],Array[String[1],1]],
  Optional['InterfaceName']        => String[1],
  Optional['Internal']             => Boolean,
  Optional['IPAMDriver']           => String[1],
  Optional['IPRange']              => Variant[String[1], Array[String[1],1]],
  ...
  Optional['Subnet']               => Variant[String[1], Array[String[1],1]],
]
